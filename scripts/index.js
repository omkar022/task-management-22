...
${url ?
        ...
        :
        `<img width='100%' src="https://reactnativecode.com/wp-content/uploads/2018/02/Default_Image_Thumbnail.png" alt='card image cap' class='img-fluid place__holder__image mg-3/>`
    }
...
<span class='badge bg-primary m-1'>${type}</span>
    ...
    <div class='card-footer'>
        ...
        type='button'
         ...
         id= ${id} 
         onclick='openTask.apply(this,argument)'
         >
            Open Task
